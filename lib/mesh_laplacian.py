"""
adapted from pytorch3d, to allow non-batch reduction
"""
...
def mesh_laplacian_smoothing(meshes, method: str = "uniform", reduction=None):
    r"""
    ...
    if reduction is None:
        return loss  # (V, 3), from kaolin lib: https://github.com/NVIDIAGameWorks/kaolin/blob/v0.1/kaolin/metrics/mesh.py#L155
