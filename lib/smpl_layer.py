...
from lib.smplpytorch.smplpytorch.native.webuser.serialization import ready_arguments
from lib.smplpytorch.smplpytorch.pytorch import rodrigues_layer
from lib.smplpytorch.smplpytorch.pytorch.tensutils import (th_posemap_axisang, th_with_zeros, th_pack, make_list, subtract_flat_id)

print('Using BLB SMPL from the project: MPI_MeshRegistration')
...
if __name__ == "__main__":
    sm_layer = SMPL_Layer(center_idx=0, gender='male',
